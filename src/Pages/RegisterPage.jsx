...
function RegisterPage() {
  ...
  // const [passwordError, setPasswordError] = useState(""); // No es necesario si usas validate en confirmPassword
  ...
  const onSubmit = handleSubmit(async (values) => {
    // La validación de que las contraseñas coinciden ya está en confirmPassword con 'validate'
    // Por lo tanto, 'passwordError' y esta condición extra ya no son estrictamente necesarias aquí.
    ...
    <div className="flex h-[calc(100vh-100px)] items-center justify-center">
      <div className="bg-zinc-800 max-w-md p-10 rounded-md">
        {registerErrors.map((error, i) => (
          <div className="bg-red-500 p-2 text-white my-2 rounded-md" key={i}> {/* Agregué my-2 rounded-md para estilo similar */}
            {error}
          </div>
        ))}
        ...
        <form onSubmit={onSubmit}>
          ...
          <input
            ...
            {...register('password', {
              ...
              // Validación para al menos una mayúscula, una minúscula, un número y un símbolo
              pattern: {
          ...
          <input
            ...
            {...register('confirmPassword', {
              ...
              validate: value => value === watch('password') || "Las contraseñas no coinciden." // Ahora esta validación es la principal
            })}
            className="w-full bg-zinc-700 text-white px-4 py-2 rounded-md my-2"
            placeholder="Repetir Contraseña"
          />
          {errors.confirmPassword && (<p className="text-red-500 text-sm mt-1">{errors.confirmPassword.message}</p>)}
          {/* El estado 'passwordError' ya no es necesario si usas el 'validate' de confirmPassword */}
      ...
      {showModal && (
        <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50">
          <div className="bg-white p-6 rounded-lg shadow-lg text-center flex flex-col items-center justify-center"> {/* Cambié flex-column a flex-col */}
            {!isVerified ? (
              <>
...
//       {showModal && (
//         <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50">
//           <div className="bg-white p-6 rounded-lg shadow-lg text-center flex flex-column items-center justifi-center">
//             {!isVerified ? (
//               <>
//                 <h2 className="text-xl font-bold mb-4">Verifica tu correo</h2>
//                 <p>Hemos enviado un correo de verificación a:</p>
