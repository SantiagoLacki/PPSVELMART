...
function TermsAndConditions() {
  return (
    <div className="terms-container">
      <div className="terms-content bg-secondary-subtle">
        <h1>Términos y Condiciones</h1>
        <p className="last-updated">Última actualización: 30 Abril 2025</p>

        <h2>1. Aceptación de los Términos</h2>
        <p>Bienvenido a Marder-Hombres (en adelante, "Marder-Hombres", "nosotros" o "nuestro"). Al acceder y utilizar nuestro sitio web https//Marder-Hombres.com y comprar nuestros productos de **ropa formal y accesorios varios**, aceptas estar sujeto a estos Términos y Condiciones. Si no estás de acuerdo con alguno de estos términos, por favor no utilices nuestro sitio web ni nuestros servicios.</p>

        <h2>2. Descripción de los Servicios</h2>
        <p>Marder-Hombres es un e-commerce que ofrece la venta de **ropa formal y accesorios varios**. Describimos nuestros productos con la mayor precisión posible, pero no garantizamos que las descripciones, imágenes u otra información del sitio web sean completamente exactas, completas o libres de errores.</p>
        ...
        <p>Para realizar una compra de **ropa formal y accesorios**, debes seguir los pasos indicados en nuestro sitio web. Una vez que realices un pedido, te enviaremos una confirmación por correo electrónico. Esta confirmación no constituye la aceptación de tu pedido, sino solo un acuse de recibo. Nos reservamos el derecho de rechazar o cancelar cualquier pedido por cualquier motivo.</p>

        <h2>6. Precios y Pago</h2>
        <p>Los precios de nuestros productos de **ropa formal y accesorios** se muestran en Pesos Argentinos e incluyen los impuestos aplicables. Nos reservamos el derecho de modificar los precios en cualquier momento sin previo aviso. Aceptamos los métodos de pago indicados en nuestro sitio web. Al realizar un pedido, nos autorizas a cargar el importe total a tu método de pago.</p>

        <h2>7. Envío y Entrega</h2>
        <p>Los plazos y costos de envío de tu pedido de **ropa formal y accesorios** se indican en nuestro sitio web. Haremos todo lo posible para entregar tu pedido dentro del plazo estimado, pero no somos responsables de los retrasos causados por circunstancias fuera de nuestro control. La propiedad y el riesgo de pérdida de los productos te serán transferidos al momento de la entrega.</p>
        ...
        <p>En la máxima medida permitida por la ley, no seremos responsables de ningún daño directo, indirecto, incidental, especial o consecuente que surja del uso de nuestro sitio web o de la compra de nuestros productos de **ropa formal y accesorios**. Nuestra responsabilidad se limita al importe total pagado por el producto o servicio en cuestión.</p>
        ...
        <p>Gracias por comprar en Marder-Hombres.</p>
      </div>
    </div>
  );
}
